...
Не переживайте! При регистрации вы указывали, как часто баланс конвертов будет сбрасываться: **раз в неделю** или **раз в месяц** — это называется Цикл конвертов

После успешной регистрации ваш финансовый цикл **уже начался**. Как только цикл подойдет к концу (через неделю или месяц) - сумма в конверте пополнится и будет равна лимиту вашего конверта.
