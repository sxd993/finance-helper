...
Во время регистрации вы указывали сумму, которую **вы получаете каждый месяц**, например это ваша средняя месячная зарплата. Именна эта сумма автоматически **распределяется между типами конвертов** по выбранному правилу — по умолчанию, **50/20/15/15**.
