...
export const ImportantCardOverview = ({ convert }: Props) => {
    ...
    return (
        <div className="group">
            <div className="rounded-2xl border border-slate-200 bg-white transition-shadow duration-300 group-hover:shadow-lg">
                <div className="p-6 space-y-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-end justify-between">
                            <div>
                                <p className="text-sm text-gray-500 mb-0.5">Остаток</p>
                                <p className="text-gray-900 text-lg font-semibold">
                                    {metrics.formattedBalance}
                                </p>
                            </div>
                            <div className="text-right">
                                <p className="text-sm text-gray-500 mb-0.5">Лимит</p>
                                <p className="text-gray-900">{metrics.formattedUsedLimit}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between text-sm pt-1 gap-2">
                            <span className="bg-slate-100 px-2 py-1 rounded-md font-medium">
                                {metrics.formattedUsedPercentage}
                            </span>
                            <span className="text-gray-600 bg-gray-50 px-2.5 py-1 rounded-md flex items-center gap-1.5">
