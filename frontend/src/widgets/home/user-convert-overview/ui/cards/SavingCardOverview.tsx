...
export const SavingCardOverview = ({ convert }: Props) => {
    const styles = getCardVariant("saving");
                ...
                <div className="p-6 space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col items-end text-right">
                            <span className="text-sm text-gray-500">Накоплено</span>
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <div className="text-right">
                            <p className="text-xs text-gray-500 mb-1">Стратегия</p>
                            <p className="text-gray-700">
                                {convert.info.is_reset ? "Периодическое пополнение" : "Свободное пополнение"}
                            </p>
                        </div>
                    </div>
                    ...
                    {formattedRemaining && (
                        <div className="text-xs text-gray-600 bg-gray-50 px-2.5 py-1 rounded-md inline-flex">
                            Осталось до цели: {formattedRemaining}
                        </div>
                    )}
                </div>
            </div>
