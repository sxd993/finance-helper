...
export const GameIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M21,6H18A6,6 0 0,0 12,0A6,6 0 0,0 6,6H3C1.89,6 1,6.89 1,8V19A5,5 0 0,0 6,24H18A5,5 0 0,0 23,19V8C23,6.89 22.11,6 21,6M12,2A4,4 0 0,1 16,6H8A4,4 0 0,1 12,2M21,19A3,3 0 0,1 18,22H6A3,3 0 0,1 3,19V8H6V12A6,6 0 0,0 12,18A6,6 0 0,0 18,12V8H21V19Z"/>
  </svg>
);
